...
const TMP_DIR = '/tmp/syncloud/youtube-ui'
...
export default async function () {
  ...
  ssh(`ls -la /data/youtube > ${TMP_DIR}/data.ls.log 2>&1`, { throw: false })
  ssh(`cat /var/snap/youtube/current/config/webui.yaml > ${TMP_DIR}/webui.yaml 2>&1`, { throw: false })
